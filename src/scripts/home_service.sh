...
sleep 5
xterm -fa "DejaVu Sans Mono" -fs 12 -fg white -bg black -e " rosrun add_markers add_markers "& 
sleep 5
xterm -fa "DejaVu Sans Mono" -fs 12 -fg white -bg black -e " rosrun pick_objects pick_objects "
